...
public class RequestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  @ExceptionHandler(value = {AuthenticationException.class, AccessDeniedException.class,
      AuthorizationDeniedException.class, InvalidBearerTokenException.class})
  ...
  public ResponseEntity<Object> handleUnprocessableCriterionException(InvalidCriterionException e,
      WebRequest request
  ) {
